...
Note QBO is NOT where invoices are born: ION creates the invoice + number, then it syncs into QBO. See [work-order-to-payment](../flows/work-order-to-payment.md).
...
- [work-order-to-payment](../flows/work-order-to-payment.md)
