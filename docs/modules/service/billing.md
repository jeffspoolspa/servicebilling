...
Per-work-order transactional billing: cache QBO invoices, enrich them, charge the card on file, record the payment, email the receipt. This is the heart of the [work-order-to-payment](../../flows/work-order-to-payment/index.md) flow.
...
- Flow: [work-order-to-payment](../../flows/work-order-to-payment/index.md)
