  ...
  async advance(monthId: string, opts: { now?: Date; dryRun?: boolean } = {}): Promise<AdvanceOutcome> {
    ...
    switch (step) {
      ...
      case "gate": {
        ...
        // RULED 2026-08-07 (final): an unresolved billing type is a GATE
        // criterion — the month holds until the setting is chosen; the
        // choice persists on the month and survives re-accrual.
