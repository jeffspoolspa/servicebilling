...
export default async function VisitsPage() {
  const visits = await listUpcomingVisits({ limit: 500 })

  // Group by visit_date for a more scannable layout.
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="text-ink-mute text-[12px] mt-0.5">
            {visits.length.toLocaleString()} scheduled across {byDate.size} days
          </div>
        </div>
      </div>
