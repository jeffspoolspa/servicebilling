-- RULED (Carter 2026-08-04): FIVE statuses, each a genuine resting state.
-- gated+held collapse (the gate stage is one place; WHY it holds is the
-- month page's detail), reconciled folds into accruing (it rests only
-- between pipeline passes). accruing / disputed / gated / invoiced / closed.
