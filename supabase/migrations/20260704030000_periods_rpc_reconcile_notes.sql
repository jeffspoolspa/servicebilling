-- maint_billing_periods gains reconcile_notes (tbp.notes — the reconcile
-- diff summary: labor_diff + per-item cons_underbilled). Return-shape change
-- -> drop + recreate.

drop function public.maint_billing_periods(date);
